...
def WSDI(season_daily_tmax, tmax_threshold, min_consec_days):
    """
...
def SU(season_daily_tmax, tmax_threshold=25):
    """
...
def CSU(season_daily_tmax, tmax_threshold=25):
    """
...
def FD(season_daily_tmin, tmin_threshold=0):
    """
...
def TN(season_daily_tmin, tmin_threshold=20):
    """
...
def RR(season_daily_precip, precip_threshold):
    """
...
def CWD(season_daily_precip, precip_threshold):
    """
